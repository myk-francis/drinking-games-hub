...
export const SPIN_BOTTLE_MODE_OPTIONS: SpinBottleModeOption[] = [
  {
    ...
    code: "CLASSIC",
    shortName: "Classic",
    name: "Classic: kiss / truth / dare / drink",
    actions: ["Kiss", "Truth", "Dare", "Drink"],
  },
  {
    id: 2,
    value: 2,
  ...
  },
  {
    ...
    code: "FLIRTY",
    shortName: "Flirty",
    name: "Flirty: compliment / kiss / confession / pick a person / drink",
    actions: ["Compliment", "Kiss", "Confession", "Pick a Person", "Drink"],
  },
  {
    id: 4,
    value: 4,
    code: "SAFE",
    shortName: "Safe",
    name: "Safe: fun question / silly dare / trivia / mini challenge / drink",
    actions: ["Fun Question", "Silly Dare", "Trivia", "Mini Challenge", "Drink"],
  },
  {
    id: 5,
    value: 5,
    code: "CHAOTIC",
    shortName: "Chaotic",
    name: "Chaotic: wildcard / steal turn / reverse / everyone drinks / drink",
    actions: ["Wildcard", "Steal Turn", "Reverse", "Everyone Drinks", "Drink"],
  },
];
